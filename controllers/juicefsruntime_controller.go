...
//+kubebuilder:rbac:groups=data.fluid.io,resources=juicefsruntimes/finalizers,verbs=update
...
func (r *JuiceFSRuntimeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *JuiceFSRuntimeReconciler) SetupWithManager(mgr ctrl.Manager) error {
