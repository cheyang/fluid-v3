...
type GooseFSRuntimeSpec struct {
	...
	// Foo is an example field of GooseFSRuntime. Edit goosefsruntime_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// GooseFSRuntimeStatus defines the observed state of GooseFSRuntime
type GooseFSRuntimeStatus struct {
...
type GooseFSRuntime struct {
	...
	Status GooseFSRuntimeStatus `json:"status,omitempty"`
}
